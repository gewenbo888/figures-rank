...
function matchRegion(native_province_en: string, region: Region): boolean {
  if (region === "all") return true;
  if (region === "mainland") return native_province_en === "Ancient & Classical";
  if (region === "us") return native_province_en === "Medieval & Early Modern";
  return native_province_en !== "Ancient & Classical" && native_province_en !== "Medieval & Early Modern";
}
...
export default function Home() {
  ...
  const filtered = useMemo(() => {
    ...
    return sorted.filter((r) => {
      ...
      return matchSearch && matchRegion(r.native_province_en, region);
    });
